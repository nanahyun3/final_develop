"""
평가 전용 original ChromaDB 구성
- 기존 DB 복사(original 컬렉션) 
...
# 기존 DB 컬렉션명
EXISTING_COLLECTION_ORIGINAL = "design_original"
...
EVAL_COLLECTION_MAP = {
    DB_CLIP:   "design_original_eval_clip",
    DB_DINOV2: "design_original_eval_dinov2",
    DB_SIGLIP: "design_original_eval_siglip",
}
...
for existing_db_path, existing_collection_name in [
    (DB_CLIP,   EXISTING_COLLECTION_ORIGINAL),
    (DB_DINOV2, EXISTING_COLLECTION_ORIGINAL),
    (DB_SIGLIP, EXISTING_COLLECTION_ORIGINAL),
]:
