...
# ── 설정 ──────────────────────────────────────────
EXISTING_DB_PATH    = "/Users/nanahyun/Documents/GitHub/final_develop/data/chroma_db(스케치, 2만개)"
EXISTING_COLLECTION = "design"
EVAL_DB_PATH        = "./chroma_eval_db" #새로운 평가용 DB 경로
EVAL_COLLECTION     = "eval_collection" #평가용 컬렉션명
REJECTED_DIR        = "./rejected_designs(통합본)/" #이미지 저장된 경로
# ─────────────────────────────────────────────────
