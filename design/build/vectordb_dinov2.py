...
# 원본 임베딩 폴더
EMBEDDING_DIR_ORIGINAL = f"{BASE_DIR}/embeddings_original_dinov2/통합"
# 스케치 임베딩 폴더
EMBEDDING_DIR_SKETCH = f"{BASE_DIR}/embeddings_sketch_dinov2/통합"

# ChromaDB 클라이언트 초기화
chroma_client = chromadb.PersistentClient(path=f"{BASE_DIR}/../chroma_db_dinov2")  # 새로운 DB 경로 설정
